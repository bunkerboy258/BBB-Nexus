...
namespace BBBNexus
{
    ...
    public class InputPipeline
    {
        ...
        private void ProcessRawInput()
        {
            ...
            currentFrame.Processed.PrimaryAttackHeld = _rawData.PrimaryAttackHeld;
            currentFrame.Processed.SecondaryAttackHeld = _rawData.SecondaryAttackHeld;
            ...
            currentFrame.Processed.InteractBufferTimer = UpdateBuffer(lastProc.InteractBufferTimer, _rawData.InteractJustPressed);
            currentFrame.Processed.PrimaryAttackBufferTimer = UpdateBuffer(lastProc.PrimaryAttackBufferTimer, _rawData.PrimaryAttackJustPressed);
            currentFrame.Processed.SecondaryAttackBufferTimer = UpdateBuffer(lastProc.SecondaryAttackBufferTimer, _rawData.SecondaryAttackJustPressed);
        ...
        public void ConsumeInteractPressed() { var f = _inputData.currentFrameData; f.Processed.InteractBufferTimer = 0f; _inputData.currentFrameData = f; }
        public void ConsumePrimaryAttackPressed() { var f = _inputData.currentFrameData; f.Processed.PrimaryAttackBufferTimer = 0f; _inputData.currentFrameData = f; }
        public void ConsumeSecondaryAttackPressed() { var f = _inputData.currentFrameData; f.Processed.SecondaryAttackBufferTimer = 0f; _inputData.currentFrameData = f; }
